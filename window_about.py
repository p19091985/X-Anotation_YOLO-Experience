...
class AboutWindow:
    ...
    def _create_widgets(self):
        ...
        row = 0
        for label, value in [
            (localization.tr('LBL_AUTHOR'), 'Patrik'),
            (localization.tr('LBL_EMAIL'), 'patrik.lima.pereira@gmail.com'),
            (localization.tr('LBL_VERSION'), '2.0.0')
        ]:
        ...
        # Ensure focus for default button behavior
        btn_close.focus_set()
